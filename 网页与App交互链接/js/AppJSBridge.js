...
var androidCallback = function (funName, routeMeta) {
...
var iosCallback = function (funName, routeMeta) {
...
var NativePageController = function (AndroidFunName, AndroidUrl, IOSFunName, IOSUrl) {
    if (window.navigator.userAgent.toLowerCase().search("wcgandroid") != -1) {
        if (window["WebViewJavascriptBridge"]) {
            var value = androidCallback(AndroidFunName, AndroidUrl);
            if( value != undefined){
                return value;
            }
        }
    } else if (window.navigator.userAgent.toLowerCase().search("wcgapple") != -1) {
        if (window["setupWebViewJavascriptBridge"]) {
            var value = iosCallback(IOSFunName, IOSUrl);
            if( value != undefined){
                return value;
            }
        }
